...
import hardcore.page.HomePageGoogle;
...
public class GoogleCloudTest {
    ...
    public void checkEmailEstimate(){
        ...
        boolean verificationCalculationResultsReceivedEmail = new HomePageGoogle(driver, data)
                .openPage()
                .fillSearchInput()
                .openCalculator(data.getChoiceCalculator())
                .activationComputeEngine()
                .choiceNumberOfInstances(data.getChoiceNumberOfIntances())
