...
public class CreateHomeGooglePageCalculator {
    ...
    public CreateHomeGooglePageCalculator fillSearchInput(){
        new WebDriverWait(driver, 15)
    ...
    public CreateHomeGooglePageCalculator choiceNumberOfIntances(String number){
        new WebDriverWait(driver, 15)
    ...
    public CreateHomeGooglePageCalculator choiceDatacentrLocacion(String center){
        new WebDriverWait(driver, 15)
    ...
    public CreateHomeGooglePageCalculator choiceCmmittedUsage(String period){
        new WebDriverWait(driver, 15)
    ...
    public CheckResultCalculator pressAddToEstimate(){
        new WebDriverWait(driver, 15)
