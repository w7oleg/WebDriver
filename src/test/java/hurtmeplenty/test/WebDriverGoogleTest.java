...
import hurtmeplenty.page.ChekResultCreatingVM;
import hurtmeplenty.page.CreateGoogleHomePage;
...
public class WebDriverGoogleTest {
    ...
    public void checkReceivedData(){
       boolean checkingFillingFieldsWellWorkCalculator = new CreateGoogleHomePage(driver, data)
                .openPage()
                .fillSearchInput()
                .openCalculator()
    ...
    public void checkTotalEstimateCost(){
        boolean totalEstimateCost = new CreateGoogleHomePage(driver, data)
                .openPage()
                .fillSearchInput()
                .openCalculator()
                .activationComputeEngine()
